...
# Script allows you to setup a daily report about virustotal hunting notificaiton
# You can send the report by email, or slack
# Reference: https://github.com/fr0gger/vthunting/blob/master/vthunting.py
